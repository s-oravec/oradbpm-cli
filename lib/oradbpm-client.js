...
function OraDBPMClient() {
  ...
  // services
  this.packageRepositoryService = require('./oradbpm-client/service/package-repository.service').PackageRepositoryServiceFactory();
  this.localConfigFileService = require('./oradbpm-client/service/local-config-file.service').LocalConfigFileServiceFactory();
